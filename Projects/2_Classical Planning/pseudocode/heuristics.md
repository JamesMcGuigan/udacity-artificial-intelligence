...
&emsp;**for each** _layer<sub>i</sub> in _graph.literalLayers_ **do**  
&emsp;&emsp;**if** _goal_ in _layer<sub>i</sub> **then return** i  
...
&emsp;_graph_.fill()  _/* fill the planning graph until it levels off */_  
&emsp;**for** _layer<sub>i</sub> in _graph.literalLayers_ **do**  
&emsp;&emsp;_allGoalsMet_ <- _true_  
&emsp;&emsp;**for each** _goal_ in _graph.goalLiterals_ **do**  
&emsp;&emsp;&emsp;**if** _goal_ not in _layer<sub>i</sub> **then** _allGoalsMet_ <- _false_  
...
&emsp;&emsp;&emsp;&emsp;**if** _layer<sub>i</sub>.isMutex(_goalA_, _goalB_) **then** _goalsAreMutex_ <- _true_  
